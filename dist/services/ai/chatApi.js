...
exports.buildChatApiResponse = exports.ChatResponseSchema = exports.AIChatRequestSchema = exports.ChatIncompleteStateSchema = exports.AIChatMessageSchema = exports.DEFAULT_CHAT_SYSTEM_INSTRUCTIONS = void 0;
 ...
 */
exports.DEFAULT_CHAT_SYSTEM_INSTRUCTIONS = 'You are a polite, conversational clarification assistant for RRH-CRMS. ' +
...
exports.AIChatMessageSchema = zod_1.z
    .object({
 ...
 */
exports.ChatIncompleteStateSchema = zod_1.z
    .object({
    status: zod_1.z.literal('INCOMPLETE'),
    missingRequirements: zod_1.z.array(zod_1.z.string().min(1)).max(16).optional(),
    ambiguities: zod_1.z.array(searchIntent_1.AmbiguitySchema).max(8).optional(),
    unsupportedCriteria: zod_1.z.array(zod_1.z.string().min(1)).max(8).optional(),
    nextAction: zod_1.z.literal('AI_CHAT').optional().default('AI_CHAT'),
})
    .strict();
/**
 ...
 */
exports.AIChatRequestSchema = zod_1.z
    .object({
    history: zod_1.z.array(exports.AIChatMessageSchema).min(1).max(50),
    incompleteState: exports.ChatIncompleteStateSchema,
})
    .strict();
/**
 ...
 * can slip through.
 */
const ChatClarificationSchema = zod_1.z
    .object({
    status: zod_1.z.literal('INCOMPLETE'),
    ...
    .strict();
const ChatCompleteSchema = zod_1.z
    .object({
    status: zod_1.z.literal('COMPLETE'),
    searchIntent: searchIntent_1.SearchIntentSchema,
})
    .strict();
exports.ChatResponseSchema = zod_1.z.discriminatedUnion('status', [
    ChatClarificationSchema,
    ChatCompleteSchema,
]);
/** Map a validated ChatResult into the HTTP response envelope. */
function buildChatApiResponse(result) {
...
exports.buildChatApiResponse = buildChatApiResponse;

...
class MessageTemplateService {
     ...
     */
    static async resolve(templateKey, ctx = {}) {
     ...
     */
    static async resolveWithFallback(templateKey, ctx = {}) {
     ...
     */
    static async setActive(templateKey, isActive) {
        return await p.messageTemplate.update({
